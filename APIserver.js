...
/*I have created an end point of / , and I make a res that return 
the string "hello world"
so when I as a client type in browser http://localhost:3000/ , it will give a res. the string "hello world"
*/
